...
export async function renderStoryboard(
  ...
  return { videoPath, videoFilename, durationSeconds: seconds(totalDurationMs(storyboard)), imageFilenames, narrationAvailable: sayIsAvailable };
}
